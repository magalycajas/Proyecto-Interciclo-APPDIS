...
a persistence unit "bancoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "banco\pom.xml":
...
artifact ("banco.war") is already built. You can build
